...
class Funcs:
    ...
    def insere_receitas_na_lista(self):
        ...
        for i in lista:
            #print(i)
            if i[6] == "Receita" and i[3][3:5] == self.data_formatada()[3:5] and i[3][6:] == self.data_formatada()[6:]:
    ...
    def insere_despesas_na_lista(self):
        ...
        lista = self.cursor.execute(""" SELECT id, descricao, valor, data, categoria, comentario, tipo FROM contas
                    ORDER BY data DESC; """)
        for linha in lista:
            if linha[6] == "Despesa" and linha[3][3:5] == self.data_formatada()[3:5] and linha[3][6:] == self.data_formatada()[6:]:
                self.treeview_aba_02.insert("", END, values=linha)

        self.desconecta_db()
    
    def variaveis_aba_03(self):
        self.mes = self.combo_data_mes_aba_03.get()
        self.ano = self.combo_data_ano_aba_03.get()
        self.categoria = self.combo_categoria_aba_03.get()
    

    def intervalo_resumo(self, inicio, dias):
        data = datetime.strptime(inicio, "%d/%m/%Y")
    ...
    def insere_resumo_na_lista(self):
        ...
        plot = 0
        for linha in lista:
            if linha[3][3:5] == self.mes and linha[3][6:] == self.ano and not self.categoria:
            ...
            elif linha[3][3:5] == self.mes and linha[3][6:] == self.ano and self.categoria:
                if linha[4] == self.categoria:
                    self.treeview_aba_03.insert("", END, values=linha)
                    filtro += 1
                    if linha[6] == "Despesa":
                        despesa += linha[2]
    ...
    def calendario_aba_01(self):
        ...
        self.calendario1.place(relx=0.465, rely=0.065)
        ...
        self.btn_calendar_data_aba_01.place(relx=0.465, rely=0.35, relwidth=0.08, relheight=0.04)
    ...
    def calendario_aba_02(self):
        ...
        self.calendario2.place(relx=0.465, rely=0.065)
        ...
        self.btn_calendar_data_aba_02.place(relx=0.465, rely=0.35, relwidth=0.08, relheight=0.04)
    ...
    def soma_receita(self):
        ...
        soma = 0
        for linha in lista:
            if linha[6] == "Receita" and linha[3][3:5] == self.data_formatada()[3:5] and linha[3][6:] == self.data_formatada()[6:]:
                #self.treeview_aba_02.insert("", END, values=linha)
                soma += linha[2]
    ...
    def salvar_em_PDF(self):
        self.variaveis_aba_03()
        self.nome_pdf = f"Relatorio-{self.mes}/{self.ano}.pdf"
        #webbrowser.open(self.nome_pdf)

    def gera_relatorio(self):
        self.variaveis_aba_03()
        if self.mes and self.ano:
            self.nomepdf = f"Relatorio-{self.mes}-{self.ano}.pdf"
            self.c = canvas.Canvas(self.nomepdf)

            self.c.setFont("Helvetica", 18)
            self.c.drawString(100, 820, "          Relatório Financeiro v1.0")
            self.c.drawString(50, 810, "--------------------------------------------------------------")
            self.c.setFont("Helvetica", 14) 
            self.c.drawString(50, 800, f"                        Mês : {self.mes} | Ano: {self.ano}")
            self.c.setFont("Helvetica", 18)
            self.c.drawString(50, 790, "--------------------------------------------------------------")
            self.c.setFont("Helvetica", 9)
            self.c.drawString(20, 780, "  Valor (R$)         |  Data       |      Tipo    |               Categoria        ")
            self.comprimento = 770
            self.c.setFont("Helvetica", 18)
            ...
            for linha in lista:
                if linha[3][3:5] >= self.mes and linha[3][6:] <= self.ano:
                    self.comprimento -= 8
    ...
    def plotar_grafico(self):
        ...
        saldo = 0
        for l in lista:
            if l[3][3:5] >= self.mes and l[3][6:] <= self.ano:
                pass
                if l[6] == "Despesa":
                    despesa += l[2]
                elif l[6] == "Receita":
    ...
    def listas(self):
        ...
        for mes in range(1, 13):
            if mes < 10:
                self.lista_mes.append(f"0{mes}")
            else:
                self.lista_mes.append(str(mes))
        

        ano = self.data_formatada()[6:]
        for ano in range(2019, int(ano)+1):
...
class Janela_Principal(Funcs):
    ...
    def tela(self):
        ...
        self.root.geometry("1250x680") #1366x768
    ...
    def frame_de_cima(self):
        ...
        self.lb_titulo['font'] = "Arial", 18, "bold"
        self.lb_titulo.place(relx=0.2, rely=0.01, relwidth=0.6)#, relheight=0.53)

        self.lb_sub_titulo = Label(self.frame_cima, text="Gestor simples de finanças pessoais.", fg="white", bg="#454545")
        self.lb_sub_titulo['font'] = "Arial", 12
        self.lb_sub_titulo.place(relx=0.2, rely=0.7, relwidth=0.6)#, relheight=0.3)
    ...
    def widgets_aba01(self):
        ...
        self.lb_titulo_aba_01['font'] = "Arial", 10
        self.lb_titulo_aba_01.place(relx=0.41, rely=0.001, relwidth=0.15) #relheight=0.025)

        # Label Descrição
        self.lb_descricao_aba_01 = Label(self.aba_01, text="Descrição", bg="#1b1b1b")
        self.lb_descricao_aba_01['font'] = "Arial", 12
        self.lb_descricao_aba_01.place(relx=0.01, rely=0.03, relwidth=0.07)# relheight=0.025)
        ...
        self.entry_descricao_aba_01.place(relx=0.01, rely=0.065, relwidth=0.3)# relheight=0.03)

        # Label Custo
        self.lb_custo_aba_01 = Label(self.aba_01, text="Valor (R$)", bg="#1b1b1b")
        self.lb_custo_aba_01['font'] = "Arial", 12
        self.lb_custo_aba_01.place(relx=0.32, rely=0.03, relwidth=0.07)# relheight=0.025)

        # Entry Custo
        self.entry_valor_aba_01 = Entry(self.aba_01, bg="lightgrey", fg="#1b1b1b")
        self.entry_valor_aba_01['font'] = "Arial", 12
        self.entry_valor_aba_01.place(relx=0.32, rely=0.065, relwidth=0.11)# relheight=0.03)

        # Label Data
        self.lb_data_aba_01 = Label(self.aba_01, text="Data", bg="#1b1b1b")
        self.lb_data_aba_01['font'] = "Arial", 12
        self.lb_data_aba_01.place(relx=0.464, rely=0.03)# relheight=0.025)
        ...
        self.btn_calendario_aba_01.place(relx=0.435, rely=0.065, relwidth=0.03, relheight=0.04)

        # Entry Data
        self.entry_data_aba_01 = Entry(self.aba_01, bg="lightgrey", fg="#1b1b1b", width=10)
        self.entry_data_aba_01['font'] = "Arial", 12
        self.entry_data_aba_01.place(relx=0.464, rely=0.065, relwidth=0.07)# relheight=0.03)

        # Label Categoria
        self.lb_categoria_aba_01 = Label(self.aba_01, text="Categoria", bg="#1b1b1b")
        self.lb_categoria_aba_01['font'] = "Arial", 12
        self.lb_categoria_aba_01.place(relx=0.01, rely=0.11, relwidth=0.069)# relheight=0.025)

        # Combobox Categoria
        self.insere_categoria_lista()
        self.combo_categoria_aba_01 = ttk.Combobox(self.aba_01, values=self.lista_itens)
        self.combo_categoria_aba_01.place(relx=0.01, rely=0.15, relwidth=0.15, relheight=0.04)
        ...
        self.btn_add_categoria_aba_01.place(relx=0.01, rely=0.191, relwidth=0.07, relheight=0.04)
        ...
        self.btn_del_categoria_aba_01.place(relx=0.08, rely=0.191, relwidth=0.07, relheight=0.04)
        ...
        self.btn_add_entry_categoria_aba_01.place(relx=0.162, rely=0.15, relwidth=0.02, relheight=0.04)
        # Entry categoria
        ...
        self.lb_comentario_aba_01.place(relx=0.32, rely=0.11, relwidth=0.0755)# relheight=0.025)
        # Entry Comentário
        ...
        self.lb_id_aba_01['font'] = "Arial", 10
        self.lb_id_aba_01.place(relx=0.265, rely=0.193)#, relwidth=0.04)# relheight=0.025)
        # Entry ID - Ready Only
        self.entry_id_aba_01 = Entry(self.aba_01, fg="white", bg="#1b1b1b")
        self.entry_id_aba_01['font'] = "Arial", 12
        self.entry_id_aba_01.place(relx=0.28, rely=0.193, relwidth=0.02)# relheight=0.03)
        ...
        self.btn_adicionar_aba_01.place(relx=0.322, rely=0.195, relwidth=0.07, relheight=0.038)
        ...
        self.btn_atualizar_aba_01.place(relx=0.397, rely=0.195, relwidth=0.07, relheight=0.038)
        ...
        self.btn_delete_aba_01.place(relx=0.472, rely=0.195, relwidth=0.07, relheight=0.038)
        ...
        self.lb_total_valor_receitas_aba_01.place(relx=0.3, rely=0.95, relwidth=0.2, relheight=0.045)
    ...
    def treeview_aba01(self):
        ...
        self.treeview_aba_01.column("#4", width=15)
    ...
    def widgets_aba02(self):
        ...
        self.lb_titulo_aba_02['font'] = "Arial", 10
        self.lb_titulo_aba_02.place(relx=0.41, rely=0.001, relwidth=0.15)# relheight=0.025)

        # Label Descrição
        self.lb_descricao_aba_02 = Label(self.aba_02, text="Descrição", bg="#1b1b1b")
        self.lb_descricao_aba_02['font'] = "Arial", 12
        self.lb_descricao_aba_02.place(relx=0.01, rely=0.03, relwidth=0.07)# relheight=0.025)
        ...
        self.entry_descricao_aba_02.place(relx=0.01, rely=0.065, relwidth=0.3)# relheight=0.03)

        # Label Valor
        self.lb_custo_aba_02 = Label(self.aba_02, text="Valor (R$)", bg="#1b1b1b")
        self.lb_custo_aba_02['font'] = "Arial", 12
        self.lb_custo_aba_02.place(relx=0.32, rely=0.03, relwidth=0.07)# relheight=0.025)

        # Entry Valor
        self.entry_valor_aba_02 = Entry(self.aba_02, bg="lightgrey", fg="#1b1b1b")
        self.entry_valor_aba_02['font'] = "Arial", 12
        self.entry_valor_aba_02.place(relx=0.32, rely=0.065, relwidth=0.11)# relheight=0.03)

        # Label Data
        self.lb_data_aba_02 = Label(self.aba_02, text="Data", bg="#1b1b1b")
        self.lb_data_aba_02['font'] = "Arial", 12
        self.lb_data_aba_02.place(relx=0.464, rely=0.03)# relheight=0.025)
        ...
        self.btn_calendario_aba_02.place(relx=0.435, rely=0.065, relwidth=0.03, relheight=0.04)

        # Entry Data
        self.entry_data_aba_02 = Entry(self.aba_02, bg="lightgrey", fg="#1b1b1b", width=10)
        self.entry_data_aba_02['font'] = "Arial", 12
        self.entry_data_aba_02.place(relx=0.464, rely=0.065, relwidth=0.07)# relheight=0.03)

        # Label Categoria
        self.lb_categoria_aba_02 = Label(self.aba_02, text="Categoria", bg="#1b1b1b")
        self.lb_categoria_aba_02['font'] = "Arial", 12
        self.lb_categoria_aba_02.place(relx=0.01, rely=0.11, relwidth=0.069)# relheight=0.025)

        # Combobox Categoria
        self.insere_categoria_despesa_lista()
        self.combo_categoria_aba_02 = ttk.Combobox(self.aba_02, values=self.lista_itens)
        self.combo_categoria_aba_02.place(relx=0.01, rely=0.15, relwidth=0.15, relheight=0.04)
        ...
        self.btn_add_categoria_aba_02.place(relx=0.01, rely=0.191, relwidth=0.07, relheight=0.04)
        # Botão Delete Categoria
        ...
        self.btn_del_categoria_aba_02.place(relx=0.08, rely=0.191, relwidth=0.07, relheight=0.04)
        # Botão Categoria Add na Entry >>
        ...
        self.btn_add_entry_categoria_aba_02.place(relx=0.162, rely=0.15, relwidth=0.02, relheight=0.04)
        # Entry categoria
        ...
        self.lb_comentario_aba_02.place(relx=0.32, rely=0.11, relwidth=0.0755)# relheight=0.025)
        # Entry Comentário
        ...
        self.lb_id_aba_02['font'] = "Arial", 10
        self.lb_id_aba_02.place(relx=0.265, rely=0.193)#, relwidth=0.04)# relheight=0.025)
        # Entry ID - Ready Only
        self.entry_id_aba_02 = Entry(self.aba_02, fg="white", bg="#1b1b1b")
        self.entry_id_aba_02['font'] = "Arial", 12
        self.entry_id_aba_02.place(relx=0.28, rely=0.193, relwidth=0.02)# relheight=0.03)
        ...
        self.btn_adicionar_aba_02.place(relx=0.322, rely=0.195, relwidth=0.07, relheight=0.038)
        ...
        self.btn_atualizar_aba_02.place(relx=0.397, rely=0.195, relwidth=0.07, relheight=0.038)
        ...
        self.btn_delete_aba_02.place(relx=0.472, rely=0.195, relwidth=0.07, relheight=0.038)
        ...
        self.lb_total_valor_despesas_aba_02.place(relx=0.3, rely=0.95, relwidth=0.2, relheight=0.045)
    ...
    def treeview_aba02(self):
        ...
        self.treeview_aba_02.column("#4", width=15)
    ...
    def widgets_aba03(self):
        ...
        # Label Mês
        self.lb_data_inicio_aba_03 = Label(self.frame_resumo_aba_03, text="Mês", bg="#1b1b1b")
        self.lb_data_inicio_aba_03['font'] = "Arial", 12
        self.lb_data_inicio_aba_03.place(relx=0.02, rely=0.01)
    
        # Combo Mês
        self.listas()
        self.combo_data_mes_aba_03 = ttk.Combobox(self.frame_resumo_aba_03, values=self.lista_mes)
        self.combo_data_mes_aba_03['font'] = "Arial", 12
        self.combo_data_mes_aba_03.place(relx=0.08, rely=0.01, relwidth=0.15)# relheight=0.08)
        
        # Label Data Fim
        self.lb_data_fim_aba_03 = Label(self.frame_resumo_aba_03, text="Ano", bg="#1b1b1b")
        self.lb_data_fim_aba_03['font'] = "Arial", 12
        self.lb_data_fim_aba_03.place(relx=0.25, rely=0.01)
        # Entry Data fim
        self.combo_data_ano_aba_03 = ttk.Combobox(self.frame_resumo_aba_03, values=self.lista_ano)
        self.combo_data_ano_aba_03['font'] = "Arial", 12
        self.combo_data_ano_aba_03.place(relx=0.31, rely=0.01, relwidth=0.15)# relheight=0.08)
        # Label e Combo Categorias
        self.lb_categoria_aba_03 = Label(self.frame_resumo_aba_03, text="Categoria", bg="#1b1b1b")
        self.lb_categoria_aba_03['font'] = "Arial", 12
        self.lb_categoria_aba_03.place(relx=0.47, rely=0.01)

        self.combo_categoria_aba_03 = ttk.Combobox(self.frame_resumo_aba_03, values=self.lista_itens)
        self.combo_categoria_aba_03['font'] = "Arial", 12
        self.combo_categoria_aba_03.place(relx=0.6, rely=0.01, relwidth=0.24)
        ...
        self.btn_pesquisar_data.place(relx=0.85, rely=0.01, relwidth=0.15)# relheight=0.08)
        ...
        self.lb_entrada_frame_resumo_aba_03['font'] = "Arial", 30
        self.lb_entrada_frame_resumo_aba_03.place(relx=0.01, rely=0.25)#, relheight=0.15)
        ...
        self.lb_saida_frame_resumo_aba_03['font'] = "Arial", 30
        self.lb_saida_frame_resumo_aba_03.place(relx=0.01, rely=0.45)#, relheight=0.15)
        ...
        self.lb_saldo_frame_resumo_aba_03['font'] = "Arial", 30
        self.lb_saldo_frame_resumo_aba_03.place(relx=0.01, rely=0.65)#, relheight=0.15)
    ...
    def treeview_aba03(self):
        ...
        self.treeview_aba_03.column("#4", width=15)
